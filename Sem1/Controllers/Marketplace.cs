...
namespace HttpServer.Controllers
{
    ...
    public class Marketplace
    {
        ...
        public string RenderMarketplace(HttpListenerContext context)
        {
            ...
            var dealList = dealRepository.RetrieveSellList();
            ...
            foreach (var collection in collections.Skip(2))
            {
                ...
                var deals = dealRepository.RetrieveCollection(collection.Id);
            ...
            var tpl = Template.Parse(File.ReadAllText("templates/marketplace/index.html"));
